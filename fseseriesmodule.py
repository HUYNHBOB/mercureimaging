...
'mercureimaging/fseseriesmodule:latest'. This tag can be changed in the file 'Makefile'
"""
...
def main(args=sys.argv[1:]):
    ...
    'fseseriesmodule [input-folder] [output-folder]'. The exact paths of the input-folder 
    ...
    if len(sys.argv) < 3:
        ...
        print("Usage: fseseriesmodule [input-folder] [output-folder]")
        sys.exit(1)
